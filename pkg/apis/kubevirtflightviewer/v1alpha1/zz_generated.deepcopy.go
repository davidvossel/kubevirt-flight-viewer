...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InFlightOperationState) DeepCopyInto(out *InFlightOperationState) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InFlightOperationState.
func (in *InFlightOperationState) DeepCopy() *InFlightOperationState {
	if in == nil {
		return nil
	}
	out := new(InFlightOperationState)
	in.DeepCopyInto(out)
	return out
}
