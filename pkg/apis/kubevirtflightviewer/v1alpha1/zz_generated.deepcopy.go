...
func (in *InFlightOperationStatus) DeepCopyInto(out *InFlightOperationStatus) {
	*out = *in
	if in.ResourceReference != nil {
		...
		*out = new(InFlightResourceReference)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InFlightResourceReference) DeepCopyInto(out *InFlightResourceReference) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InFlightResourceReference.
func (in *InFlightResourceReference) DeepCopy() *InFlightResourceReference {
	if in == nil {
		return nil
	}
	out := new(InFlightResourceReference)
